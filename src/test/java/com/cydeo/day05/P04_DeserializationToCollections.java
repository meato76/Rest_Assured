...
public class P04_DeserializationToCollections extends SpartanTestBase {
    ...
    public void test1(){
        ...
        // If you want to convert your JSON to Java collection(map,list,custom class)..
        //this is called Deserialization
        // Convert JSON to --> JAVA
        //to do this we need either Jackson or Gson
        // which one we add tp pom.xml
        //Jackson
    ...
    public void test2(){
       ...
       // }
        ...
        //how to find first spartan info
        System.out.println("listSpartan.get(9) = " + listSpartan.get(9));
